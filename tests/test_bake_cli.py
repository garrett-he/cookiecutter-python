...
def test_bake_with_cli(cookies: Cookies):
    ...
    assert result.project_path.joinpath(f'src/{result.context["project_package"]}/cli/__init__.py').exists()
    assert result.project_path.joinpath(f'src/{result.context["project_package"]}/cli/app.py').exists()
    assert result.project_path.joinpath(f'src/{result.context["project_package"]}/cli/commands/__init__.py').exists()
    ...
    assert not result.project_path.joinpath(f'src/{result.context["project_package"]}/cli').exists()
